...
#define MTD_OTP_USER_SET_PASSWORD 3
#define MTD_OTP_USER_PROGRAM_PASSWORD 4
#define MTD_OTP_USER_GET_EXT_INFO 5
#endif
...
#if defined(HUMAX_PLATFORM_BASE)
	MTD_MODE_OTP_SET_PASSWORD = MTD_OTP_USER_SET_PASSWORD,
	MTD_MODE_OTP_PROGRAM_PASSWORD = MTD_OTP_USER_PROGRAM_PASSWORD,
	MTD_MODE_OTP_GET_EXT_INFO = MTD_OTP_USER_GET_EXT_INFO,
#endif
	MTD_MODE_RAW,
};
