...
#if defined(HUMAX_PLATFORM_BASE)
	int (*write_password_prot_reg) (int mode,struct mtd_info *mtd, loff_t from, size_t len, size_t *retlen, u_char *buf);
	int (*read_ext_info) (struct mtd_info *mtd, struct mtd_ext_info *buf);
#endif
