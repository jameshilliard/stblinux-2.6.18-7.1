...
#if defined(HUMAX_PLATFORM_OCTO) /* 임시 수정 임..  */
#undef UARTA_ADR_BASE
#define	UARTA_ADR_BASE	UARTB_ADR_BASE
#endif
...
turn_on_mux(int chan)
{
	...
	if (chan == 1) { // UartB
		/*
		 * uart_txdb is bit 00:01 value 0 PIN_MUX_CONTROL_11
		 * uart_rxdb is bit 31:30 value 0 PIN_MUX_CONTROL_10
		 */
		 pvul = (volatile unsigned long*) SUN_TOP_CTRL_PIN_MUX_CTRL_10;
		*pvul &= 0x3fffffff; // CLear it

		pvul = (volatile unsigned long*) SUN_TOP_CTRL_PIN_MUX_CTRL_11;
