...
#if defined(CONFIG_MIPS_BCM7405B0)
extern int g_Uma32_Sata;
#endif
#endif
...
/* For the 97xxx series STB, process CFE boot parms */
...
#endif
		par_val2 = (get_RAM_size()-1) & 0xffff0000;
#if defined(HUMAX_PLATFORM_BASE) && defined(CONFIG_MIPS_BCM7405B0)
		/* Disable RAC */
		rac_setting(0);
		/* Disable L2 DBG about CopyBack */
		l2_setting(0);
#endif
	  }
	}
	...
	if(g_Uma32_Sata == 1)
	{
		printk("Sata 3Gbps forced 1.5Gbps\n");
		gSata2_3Gbps = 0;
	}
#endif
#endif
